-- Percent signs are doubled: DMF runs every localized string through
-- string.format, so a bare "%" is an invalid format option and takes the widget
-- it belongs to down with it. tests/i_wanna_see_spec.lua guards this.
return {
	mod_name = {
		en = "I Wanna See",
	},
